jQuery(function () {
    ...
    function initC3Chart() {
        var analyticsconfig = {
            ...
            data: {
                columns: [
                    ["Manufacture 1", 30, 100, 80, 140, 150, 200, 250, 150,150],
                    ["Manufacture 2", 90, 100, 170, 140, 190, 50, 100, 150,150],
                    ["Manufacture 3", 10, 150, 200, 440, 190, 50, 200, 250,150]
                ],
                type: "spline",
                types: {
                }
