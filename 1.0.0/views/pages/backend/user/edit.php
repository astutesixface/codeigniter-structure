    ...
    <div class="tab-pane fade active in" id="edit">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="name" value="<?php echo $row['first_name']; ?>" id="demo-hor-1" class="form-control required" placeholder="<?php echo translate('name'); ?>" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php
                    $role = $this->ion_auth->get_users_groups($row['id'])->row()->id;

                    if (!$role) {
                        $role = '';
                    }
                    echo $this->crud_model->select_html('groups', 'role', 'name', 'edit', 'demo-chosen-select required', $role, '');
                    ?>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(".emails").blur(function () {
        var email = $(".emails").val();
         $.post("<?php echo base_url(); ?>index.php/admin/exists/<?=$row['id']?>",
                {
