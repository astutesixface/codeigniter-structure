                    ...
                    <form role="form" id="navigation_form" action="<?php echo base_url(); ?>admin/navigation/save_navigation/<?php if(!empty($menu_info->menu_id)){ echo $menu_info->menu_id;} ?>" method="post" class="form-horizontal form-groups-bordered">
