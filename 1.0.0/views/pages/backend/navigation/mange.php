<link href="<?php echo base_url(); ?>assets/admin/plugins/jquery-nestable/style.css" rel="stylesheet" type="text/css" />
<div id="wrapper">
  <div class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <a href="#" onclick="save_menu();return false;" class="btn btn-info"><?php echo translate('utilities_menu_save'); ?></a>
          </div>
        </div>
      </div>
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
           <?php
           $menu_active = $this->db->where('type','aside_menu_active')->get('ui_settings')->row()->value;
           $menu_active = json_decode($menu_active);
           $menu_inactive = $this->db->where('type','aside_menu_inactive')->get('ui_settings')->row()->value;
           $menu_inactive = json_decode($menu_inactive);
           ?>
           <div class="clearfix"></div>
           <div class="row">
            <div class="col-md-6 border-right">
              <h4 class="bold"> active_menu_items </h4>
              <div class="dd active">
                <?php
                $i = 1;
                ...
                foreach($menu_active->aside_menu_active as $item){
                  ...
                  <div class="menu-options main-item-options" style="display:none;" data-menu-options="<?php echo $item->id; ?>">
                   <label class="control-label"><?php echo translate('utilities_menu_name'); ?></label>
                   <div class="input-group">
                     ...
                     <span class="input-group-addon"><i class="fa fa-question" data-toggle="tooltip" data-placement="left" data-title="<?php echo translate('utilities_menu_translate_name_help'); ?>"></i></span>
                   </div>
                   <label class="control-label"><?php echo translate('utilities_menu_url'); ?></label>
                   <div class="input-group">
                     <?php
                     $url = '#';
                    ...
                    <span class="input-group-addon"><i class="fa fa-question" data-toggle="tooltip" data-placement="left" data-title="<?php echo translate('utilities_menu_url_help'); ?>"></i></span>
                  </div>
                  <div class="form-group">
                   <label class="control-label"><?php echo translate('utilities_menu_icon'); ?> <i class="<?php echo $item->icon; ?>"></i></label>
               ...
               // echo render_select('permission',$permissions,array('shortname','name'),translate('utilities_menu_permission'),$selected); ?>
              </div>
              ...
              <ol class="dd-list">
                ...
                <li class="dd-item dd3-item sub-items" data-id="<?php echo $submenu->id; ?>">
                  <div class="dd-handle dd3-handle"></div>
                  <?php $name = translate($submenu->name);
                  if(strpos($name,'translate_not_found') !== false){
                    $name = $submenu->name;
                  }
                  ?>
                 ...
                 <div class="menu-options sub-item-options" style="display:none;" data-menu-options="<?php echo $submenu->id; ?>">
                  ...
                  <div class="form-group">
                   <label class="control-label"><?php echo translate('utilities_menu_icon'); ?> <i class="<?php echo $submenu->icon; ?>"></i></label>
  ...
  <div class="col-md-6">
   <h4 class="bold"><?php echo translate('inactive_menu_items'); ?></h4>
...
<script src="<?php echo base_url(); ?>assets/admin/plugins/jquery-nestable/jquery.nestable.js"></script>
<script>
  ...
  //    main_menu.data('permission', permission);
    ...
    $.post(base_url + 'admin/navigation/update_aside_menu', data).success(function() {
