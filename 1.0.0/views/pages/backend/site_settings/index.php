...
<div id="content-container"> 
    ...
    <div class="tab-base">
        <div class="panel">
            <div class="tab-base tabs-vertical ">
                ...
                <div class="tab-content bg_grey">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                	<div class="inner-div tr-bg img-fixed">
                                                    	<img class="img-responsive " src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $admin_login_logo; ?>.png" id="admin_login_logo">
                                                    </div>
                                                </td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<div class="inner-div tr-bg img-fixed">
                                                    	<img class="img-responsive " src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $home_top_logo; ?>.png" id="home_top_logo" >
                                                    </div>
                                                </td>
                                                <td class="text-right">
                                                    <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<div class="inner-div tr-bg img-fixed">
                                                    	<img class="img-responsive " src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $home_bottom_logo; ?>.png" id="home_bottom_logo" alt="User_Image" >
                                                    </div>
                                                </td>
                                                <td class="text-right">
                                                    <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                    ...
                    <div id="demo-stk-lft-tab-3" class="tab-pane fade">
                         <div class="col-md-12">
							...
							<?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/favicon_settings/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                    ...
                    <div id="demo-stk-lft-tab-c" class="tab-pane fade">
                        <div class="col-md-12">
                            ...
                            ?>
								<?php
                                    echo form_open(base_url() . 'index.php/admin/general_settings/product_comment/', array(
                                        'class' => 'form-horizontal',
                                        'method' => 'post',
                                        'id' => '',
                                        'enctype' => 'multipart/form-data'
                ...
                ?>
							<?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/social_login_settings/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
