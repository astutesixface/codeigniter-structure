...
class MY_Controller extends CI_Controller {
    ...
    protected function render($template = 'main', $_view = false) {
        ...
        if ($this->action_name == "auth/login" && $this->controller_name == "welcome") {
            $this->controller_name = '';
        } else if ($this->action_name == "auth/login" && $this->controller_name == "auth") {
            $this->controller_name = '';
        }
        $view_path = $this->controller_name . '/' . $this->action_name . '.php'; //set the path off the view
        $head_path = $this->controller_name . '/head/' . $this->action_name . '.php'; //set the path off the view
        $footer_path = $this->controller_name . '/footer/' . $this->action_name . '.php'; //set the path off the view
